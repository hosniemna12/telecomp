...
class Dashboard extends Component
{
    ...
    public function render()
    {
        $stats = [
            ...
            'montant_total' => TcEnrDetail::sum('montant') ?? 0,
        ];
        ...
        $statsParType = [
            ...
            'cheques'      => TcFichier::whereIn('type_valeur', ['30','31','32'])->count(),
        ];
        ...
        return view('livewire.dashboard', compact(
            'stats', 'derniersFichiers', 'derniersLogs',
            'statsParType', 'fichiersParJour', 'topTransactions'
        ));
    }
}
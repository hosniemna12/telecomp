...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .notif-btn:hover { border-color: var(--border-active); color: var(--text-primary); }
        .notif-dot {
            position: absolute;
            top: 7px; right: 7px;
        ...
        .stat-icon.blue  { background: var(--blue-dim); color: var(--blue-acc); }
        ...
        .badge-blue    { background: var(--blue-dim); color: var(--blue-acc); }
        .badge-blue::before { background: var(--blue-acc); }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('fichiers.upload') }}"
           class="nav-item {{ request()->routeIs('fichiers.upload') ? 'active' : '' }}">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="{{ route('fichiers.index') }}"
           class="nav-item {{ request()->routeIs('fichiers.index') || request()->routeIs('fichiers.show') ? 'active' : '' }}">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="{{ route('rejets.index') }}"
           class="nav-item {{ request()->routeIs('rejets.index') ? 'active' : '' }}">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="{{ route('rejets.pacs004') }}"
           class="nav-item {{ request()->routeIs('rejets.pacs004') ? 'active' : '' }}">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="{{ route('stats.index') }}"
           class="nav-item {{ request()->routeIs('stats.index') ? 'active' : '' }}">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="{{ route('audit.index') }}"
           class="nav-item {{ request()->routeIs('audit.index') ? 'active' : '' }}">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
